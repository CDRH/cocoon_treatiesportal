...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
  ...
  <xsl:template match="TEI">
    <html>
      <head>
        <title>
          Insights from editions of The Annual Register 
          regarding later variants of the oyal Proclamation of 1763:
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-29384302-1']);
  ...
  (function() {
    ...
    <!-\- edit -\-><a href="searchHelp.html" class="help">Search Help</a></form>-->
              ...
              <h1>Insights from editions of <em>The Annual Register</em> 
                regarding later variants of the <em>Royal Proclamation of 1763</em>:
                An application of Levenshtein’s edit distance metric</h1>
