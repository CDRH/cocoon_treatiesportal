...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
  ...
  <xsl:template match="TEI">
    <html>
      <head>
        ...
        <script type="text/javascript">
          <![CDATA[
          var _gaq = _gaq || [];
          _gaq.push(['_setAccount', 'UA-18408904-1']);
        ...
        <div id="mainwrapper">
          ...
          <div id="secondwrapper">
            ...
            <div id="projecthead">
              ...
              <div class="mainmenu">
                <xsl:if test="not(/TEI/@xml:id = 'csa.solong')">
    ...
    <!-\- edit -\-><a href="searchHelp.html" class="help">Search Help</a></form>-->
              ...
              <h1>
                <!--<xsl:value-of select="/TEI/teiHeader/fileDesc/titleStmt/title"/>--> As long as grass shall grow and water run: The treaties formed by the Confederate States of America and the tribes in Indian Territory, 1861 </h1>
...
-->
  ...
  <xsl:template match="pb">
    ...
    <span class="page">
      ...
      <xsl:if test="@n">
        <!--&#160;&#160;&#160;-->
        <a href="images/images.html?n={@n}&amp;ref={//TEI/@xml:id}">
          <img src="figures/100px/p{@n}.jpg" class="pg" alt="page {@n}"/>
          <br/>
  ...
  <xsl:template match="milestone[@unit='crosses']">
    <xsl:choose>
      <xsl:when test="/TEI/text/body/milestone[3]"/>
      <xsl:otherwise>
  ...
  <xsl:template match="head">
    ...
    <xsl:choose>
      ...
      <!--<xsl:when test="/TEI/text/body/head[1]"/>-->
  ...
  <xsl:template match="term"><em><xsl:apply-templates/></em></xsl:template>
