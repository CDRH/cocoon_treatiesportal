...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
  ...
  <xsl:template match="TEI">
    <html>
      <head>
        <title>The Indians of the Northern and Southern Districts of North America: 
   ...
   var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-47549738-1']);
  ...
  (function() {
    ...
    var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(ga, s);
        ...
        <base href="http://treatiesportal.unl.edu/planof1764/" />
      </head>
        ...
        <div id="mainwrapper">
          ...
          <div id="secondwrapper">
            ...
            <div id="projecthead">
              ...
              <h1>The Indians of the Northern and Southern Districts of North America: 
                Levenshtein comparisons of the tribe lists from the 
                1764 "Plan for the future management of Indian affairs"</h1>
  ...
  <xsl:template match="hi[@rend='italics'] | term">
    <em>
      <xsl:apply-templates/>
    </em>
  </xsl:template>
