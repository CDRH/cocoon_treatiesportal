...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
  ...
  <xsl:template match="TEI">
    <html>
      <head>
        <title>The deployment of the terms indigenous, aboriginal, and Indian(s) in the texts of international constitutions</title>
...
&#160;
  ...
  <xsl:template match="hi[@rend='yellow']">
    <span class="yellow">
      <xsl:apply-templates/>
    </span>
  </xsl:template>
...
<!--  <xsl:template match="title[@type='main']">
  ...
  <xsl:template match="ref">
     ...
     <xsl:choose>
       ...
       <xsl:when test="@n and starts-with(@n, 'Appendix')">
        <a name="{@target}.ref"/>
        <a href="#{@target}">
  ...
  <xsl:template match="pb">
    ...
    <span class="page">
      ...
      <xsl:if test="@n"> &#160;&#160;&#160;<a
        ...
        <img src="jpg/thumbs/{@n}.jpg" class="pg pb_image" alt="page {@n}"/>
          <br/>
  ...
  <xsl:template match="figure">
    <div class="graphic">
      <!-- edit -->
      <img class="figures_image" src="images/{@facs}"/>
      <xsl:apply-templates/>
    </div>
  </xsl:template>
    ...
    <xsl:choose>
      <xsl:when test="@xml:id">
        ...
        <div>
          ...
          <xsl:apply-templates/>
          <xsl:if test="starts-with(@xml:id, 'appendix')">
            <xsl:text>[</xsl:text>
            <a href="#{@xml:id}.ref">back</a>
            <xsl:text>]</xsl:text>
          </xsl:if>
          </div>
      </xsl:when>
