                ...
                <div id="mainwrapper">
                    ...
                    <div id="secondwrapper">
                        ...
                        <div id="projecthead">
                            ...
                            <div class="mainmenu">
                                ...
                                <form action="search" method="get" style="margin-top: 0px;">
                                    ...
                                    <br/>
                                    <!-- edit -->
                                    <a href="{$siteroot}searchHelp.html" class="help">Search Help</a>
                                </form>
                        ...
                        <div id="content">
                            ...
                            <xsl:choose>
                                <xsl:when test="contains($searchTerm, '*')">Search does not support wildcard functionality at this time. Please rerun your query without the asterisk (*). You may wish to consult the <a href="{$siteroot}searchHelp.html">search help</a> page as well. 
                                    <br/><br/>
