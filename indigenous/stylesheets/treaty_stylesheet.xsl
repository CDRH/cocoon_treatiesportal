...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
  ...
  <xsl:template match="TEI">
   ...
   var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-47451581-1']);
...
&#160;
              ...
              <h1>The deployment of the terms <em>indigenous</em>, <em>aboriginal</em>, and <em>Indian(s)</em> in the texts of international constitutions</h1>
